...
TrOnShList = [TrOnSh[:,0]-TrOnSh[:,10], TrOnSh[:,1]-TrOnSh[:,10],TrOnSh[:,2]-TrOnSh[:,10], TrOnSh[:,3]-TrOnSh[:,10],
              TrOnSh[:,4]-TrOnSh[:,10],TrOnSh[:,5]-TrOnSh[:,11], TrOnSh[:,6]-TrOnSh[:,12], TrOnSh[:,7]-TrOnSh[:,10],
              TrOnSh[:,8]-TrOnSh[:,10], TrOnSh[:,9]-TrOnSh[:,10],TrOnSh[:,13]-TrOnSh[:,10],TrOnSh[:,14]-TrOnSh[:,11],
              TrOnSh[:,15]-TrOnSh[:,12],TrOnSh[:,16]-TrOnSh[:,10],TrOnSh[:,17]-TrOnSh[:,11], TrOnSh[:,18]-TrOnSh[:,12],
              TrOnSh[:,19]-TrOnSh[:,10],TrOnSh[:,20]-TrOnSh[:,10],TrOnSh[:,21]-TrOnSh[:,10]]
HWCList = [HWC[:,0]-HWC[:,10], HWC[:,1]-HWC[:,10],HWC[:,2]-HWC[:,10], HWC[:,3]-HWC[:,10], HWC[:,4]-HWC[:,10],
           HWC[:,5]-HWC[:,11], HWC[:,6]-HWC[:,12],HWC[:,7]-HWC[:,10],HWC[:,8]-HWC[:,10], HWC[:,9]-HWC[:,10],
           HWC[:,13]-HWC[:,10],HWC[:,14]-HWC[:,11], HWC[:,15]-HWC[:,12],HWC[:,16]-HWC[:,10],HWC[:,17]-HWC[:,11],
           HWC[:,18]-HWC[:,12],HWC[:,19]-HWC[:,10],HWC[:,20]-HWC[:,10], HWC[:,21]-HWC[:,10]]

vertical = (LID1+LID2)
total = (CS1+CS2+CS3sb+CS4+CS5)-(CS1+CS2+CS3sb+CS4+CS5)
...
plt.show()
fig42.savefig('results/figures/PosterOSM16/PevAllMetricsCanyonEffectAdvectivePhaseAllShelf.eps', format='eps', dpi=1000, bbox_inches='tight')
#-----------------------------------------------------------------------------------------------------------------------------
...
plt.show()
fig43.savefig('results/figures/PosterOSM16/PehAllMetricsCanyonEffectAdvectivePhaseAllShelf.eps', format='eps', dpi=1000, bbox_inches='tight')
#-----------------------------------------------------------------------------------------------------------------------------
...
plt.show()
fig44.savefig('results/figures/PosterOSM16/KappaAllMetricsCanyonEffectAdvectivePhaseAllShelf.eps', format='eps', dpi=1000, bbox_inches='tight')
#-----------------------------------------------------------------------------------------------------------------------------
