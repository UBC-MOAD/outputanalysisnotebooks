...
def main():
    ...
    Us_model = np.array([0.365 ,
                        ...
                        0.229,
                        0.220,
                        0.365,]) # Check Incoming_U_all_runs.ipynb for source
    ...
    Hhs = np.array([99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,
                    ...
                    99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,
                    99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7,99.7, 
                    99.7, 99.7,52.3,52.3,77.4,77.4,52.3,52.3,52.3,77.4,52.3,99.7]) 
    ...
    Hinds = np.array([20,20,20,20,20,20,20,20,20,20,
                      ...
                      20,20,20,20,20,20,20,20,20,20,
                      20,20,20,20,20,20,20,20,20,20,
                      20,20,10,10,14,14,10,10,10,14,10,20])
    ...
    Hrs = np.array([108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1,
                   ...
                   108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1,
                   108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1, 108.1,
                   108.1, 108.1, 69.1, 69.1,   89.1,  89.1,  69.1,  69.1,  89.1,  89.1, 69.1, 108.1])
