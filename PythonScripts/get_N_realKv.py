...
expList = ['/data/kramosmu/results/TracerExperiments/3DVISC_REALISTIC/run11',
           ...
           '/data/kramosmu/results/TracerExperiments/3DVISC_REALISTIC/run14']
           
expNames = ['3DVISC_REALISTIC_run11',
